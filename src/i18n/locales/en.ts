...
const en: TranslationTable = {
    ...
    'editor.export.downloadRaw': 'Download Original (WebM)',
    ...
    'converter.nav': 'WebM Converter',
    'converter.title': 'WebM to MP4 Converter',
    'converter.subtitle': 'Convert any WebM recording to MP4 — entirely in your browser, no upload needed.',
    'converter.drop.idle': 'Drop a video file here, or click to browse',
    'converter.drop.hint': 'Supports WebM, MP4, MKV and other video formats',
    'converter.drop.active': 'Drop to load file',
    'converter.quality.label': 'Output Quality',
    'converter.progress.label': 'Converting…',
    'converter.done.title': 'Conversion complete!',
    'converter.error': 'Conversion failed. Please try again.',
    'converter.btn.convert': 'Convert to MP4',
    'converter.btn.cancel': 'Cancel',
    'converter.btn.download': 'Download MP4',
    'converter.btn.again': 'Convert another file',
