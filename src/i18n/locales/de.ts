...
const de: TranslationTable = {
    ...
    'app.footer.line1': 'Gebaut mit React, Tailwind & WebCodecs • yapweijun1996',
    ...
    'editor.export.downloadRaw': 'Original herunterladen (WebM)',
    ...
    'converter.nav': 'WebM-Konverter',
    'converter.title': 'WebM zu MP4 Konverter',
    'converter.subtitle': 'WebM-Videos direkt im Browser in MP4 konvertieren — kein Upload nötig.',
    'converter.drop.idle': 'Videodatei hierher ziehen oder klicken zum Auswählen',
    'converter.drop.hint': 'Unterstützt WebM, MP4, MKV und andere Videoformate',
    'converter.drop.active': 'Loslassen zum Laden',
    'converter.quality.label': 'Ausgabequalität',
    'converter.progress.label': 'Konvertierung läuft…',
    'converter.done.title': 'Konvertierung abgeschlossen!',
    'converter.error': 'Konvertierung fehlgeschlagen. Bitte erneut versuchen.',
    'converter.btn.convert': 'In MP4 konvertieren',
    'converter.btn.cancel': 'Abbrechen',
    'converter.btn.download': 'MP4 herunterladen',
    'converter.btn.again': 'Weitere Datei konvertieren',
