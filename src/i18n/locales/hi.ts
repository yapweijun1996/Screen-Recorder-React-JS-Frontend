...
const hi: TranslationTable = {
    ...
    'converter.nav': 'WebM कनवर्टर',
    'converter.title': 'WebM से MP4 कनवर्टर',
    'converter.subtitle': 'अपने WebM रिकॉर्डिंग को ब्राउज़र में MP4 में बदलें — कोई अपलोड नहीं।',
    'converter.drop.idle': 'यहाँ वीडियो फ़ाइल खींचें, या चुनने के लिए क्लिक करें',
    'converter.drop.hint': 'WebM, MP4, MKV और अन्य वीडियो फॉर्मेट समर्थित',
    'converter.drop.active': 'फ़ाइल लोड करने के लिए छोड़ें',
    'converter.quality.label': 'आउटपुट गुणवत्ता',
    'converter.progress.label': 'कनवर्ट हो रहा है…',
    'converter.done.title': 'कनवर्जन पूर्ण!',
    'converter.error': 'कनवर्जन विफल। कृपया पुनः प्रयास करें।',
    'converter.btn.convert': 'MP4 में कनवर्ट करें',
    'converter.btn.cancel': 'रद्द करें',
    'converter.btn.download': 'MP4 डाउनलोड करें',
    'converter.btn.again': 'अन्य फ़ाइल कनवर्ट करें',
