...
const es: TranslationTable = {
    ...
    'app.footer.line1': 'Creado con React, Tailwind y WebCodecs • yapweijun1996',
    ...
    'converter.nav': 'Convertidor WebM',
    'converter.title': 'Convertidor WebM a MP4',
    'converter.subtitle': 'Convierte grabaciones WebM a MP4 directamente en tu navegador, sin subir archivos.',
    'converter.drop.idle': 'Arrastra un archivo de video aquí, o haz clic para seleccionar',
    'converter.drop.hint': 'Compatible con WebM, MP4, MKV y otros formatos de video',
    'converter.drop.active': 'Suelta para cargar el archivo',
    'converter.quality.label': 'Calidad de salida',
    'converter.progress.label': 'Convirtiendo…',
    'converter.done.title': '¡Conversión completada!',
    'converter.error': 'Error en la conversión. Inténtalo de nuevo.',
    'converter.btn.convert': 'Convertir a MP4',
    'converter.btn.cancel': 'Cancelar',
    'converter.btn.download': 'Descargar MP4',
    'converter.btn.again': 'Convertir otro archivo',
