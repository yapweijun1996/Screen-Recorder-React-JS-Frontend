...
const id: TranslationTable = {
    ...
    'converter.nav': 'Konverter WebM',
    'converter.title': 'Konverter WebM ke MP4',
    'converter.subtitle': 'Konversi rekaman WebM ke MP4 langsung di browser — tanpa upload.',
    'converter.drop.idle': 'Seret file video ke sini, atau klik untuk memilih',
    'converter.drop.hint': 'Mendukung WebM, MP4, MKV dan format video lainnya',
    'converter.drop.active': 'Lepas untuk memuat file',
    'converter.quality.label': 'Kualitas Output',
    'converter.progress.label': 'Mengonversi…',
    'converter.done.title': 'Konversi selesai!',
    'converter.error': 'Konversi gagal. Silakan coba lagi.',
    'converter.btn.convert': 'Konversi ke MP4',
    'converter.btn.cancel': 'Batal',
    'converter.btn.download': 'Unduh MP4',
    'converter.btn.again': 'Konversi file lain',
