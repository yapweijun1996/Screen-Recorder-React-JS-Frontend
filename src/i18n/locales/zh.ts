...
const zh: TranslationTable = {
    ...
    'converter.nav': 'WebM 转换器',
    'converter.title': 'WebM 转 MP4 转换器',
    'converter.subtitle': '在浏览器中直接转换 WebM 视频为 MP4，无需上传。',
    'converter.drop.idle': '将视频文件拖拽到此处，或点击选择文件',
    'converter.drop.hint': '支持 WebM、MP4、MKV 等视频格式',
    'converter.drop.active': '松开鼠标以加载文件',
    'converter.quality.label': '输出质量',
    'converter.progress.label': '转换中…',
    'converter.done.title': '转换完成！',
    'converter.error': '转换失败，请重试。',
    'converter.btn.convert': '转换为 MP4',
    'converter.btn.cancel': '取消',
    'converter.btn.download': '下载 MP4',
    'converter.btn.again': '转换其他文件',
