...
const fr: TranslationTable = {
    ...
    'recorder.errors.notFound': "Aucune caméra ou microphone trouvé. Veuillez connecter un appareil et réessayer.",
    'recorder.errors.notReadable': "La caméra ou le microphone est utilisé par une autre application.",
    'recorder.errors.overconstrained': "Les paramètres média demandés ne sont pas pris en charge par votre appareil.",
    ...
    'editor.export.downloadRaw': "Télécharger l'original (WebM)",
    ...
    'converter.nav': 'Convertisseur WebM',
    'converter.title': 'Convertisseur WebM vers MP4',
    'converter.subtitle': 'Convertissez vos enregistrements WebM en MP4 directement dans votre navigateur, sans upload.',
    'converter.drop.idle': 'Déposez un fichier vidéo ici ou cliquez pour en sélectionner un',
    'converter.drop.hint': 'Prend en charge WebM, MP4, MKV et autres formats vidéo',
    'converter.drop.active': 'Relâchez pour charger le fichier',
    'converter.quality.label': 'Qualité de sortie',
    'converter.progress.label': 'Conversion en cours…',
    'converter.done.title': 'Conversion terminée !',
    'converter.error': 'Échec de la conversion. Veuillez réessayer.',
    'converter.btn.convert': 'Convertir en MP4',
    'converter.btn.cancel': 'Annuler',
    'converter.btn.download': 'Télécharger le MP4',
    'converter.btn.again': 'Convertir un autre fichier',
