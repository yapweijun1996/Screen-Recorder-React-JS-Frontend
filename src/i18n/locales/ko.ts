...
const ko: TranslationTable = {
    ...
    'editor.export.cancel': '내보내기 취소',

    'converter.nav': 'WebM 변환기',
    'converter.title': 'WebM to MP4 변환기',
    'converter.subtitle': '브라우저에서 WebM 녹화를 MP4로 변환 — 업로드 불필요.',
    'converter.drop.idle': '여기에 동영상 파일을 드롭하거나 클릭하여 선택',
    'converter.drop.hint': 'WebM, MP4, MKV 등 동영상 형식 지원',
    'converter.drop.active': '파일을 로드하려면 놓으세요',
    'converter.quality.label': '출력 품질',
    'converter.progress.label': '변환 중…',
    'converter.done.title': '변환 완료!',
    'converter.error': '변환에 실패했습니다. 다시 시도해 주세요.',
    'converter.btn.convert': 'MP4로 변환',
    'converter.btn.cancel': '취소',
    'converter.btn.download': 'MP4 다운로드',
    'converter.btn.again': '다른 파일 변환',
