...
const ja: TranslationTable = {
    ...
    'converter.nav': 'WebM 変換ツール',
    'converter.title': 'WebM → MP4 変換ツール',
    'converter.subtitle': 'WebM 録画をブラウザ内で MP4 に変換 — アップロード不要。',
    'converter.drop.idle': 'ここに動画ファイルをドロップ、またはクリックして選択',
    'converter.drop.hint': 'WebM、MP4、MKV などの動画形式に対応',
    'converter.drop.active': 'ドロップしてファイルを読み込む',
    'converter.quality.label': '出力品質',
    'converter.progress.label': '変換中…',
    'converter.done.title': '変換完了！',
    'converter.error': '変換に失敗しました。もう一度お試しください。',
    'converter.btn.convert': 'MP4 に変換',
    'converter.btn.cancel': 'キャンセル',
    'converter.btn.download': 'MP4 をダウンロード',
    'converter.btn.again': '別のファイルを変換',
