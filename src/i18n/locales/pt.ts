...
const pt: TranslationTable = {
    ...
    'app.footer.line1': 'Feito com React, Tailwind e WebCodecs • yapweijun1996',
    ...
    'editor.export.downloadRaw': 'Baixar original (WebM)',
    ...
    'editor.export.modalExporting': 'Exportando para {{format}}...',
    'editor.export.modalStayHint': 'Permaneça nesta aba para melhor desempenho. Trocar de aba pode retardar o processamento.',
    'editor.export.cancel': 'Cancelar exportação',

    'converter.nav': 'Conversor WebM',
    'converter.title': 'Conversor WebM para MP4',
    'converter.subtitle': 'Converta gravações WebM para MP4 diretamente no navegador — sem upload.',
    'converter.drop.idle': 'Solte um arquivo de vídeo aqui ou clique para selecionar',
    'converter.drop.hint': 'Suporta WebM, MP4, MKV e outros formatos de vídeo',
    'converter.drop.active': 'Solte para carregar o arquivo',
    'converter.quality.label': 'Qualidade de saída',
    'converter.progress.label': 'Convertendo…',
    'converter.done.title': 'Conversão concluída!',
    'converter.error': 'Falha na conversão. Tente novamente.',
    'converter.btn.convert': 'Converter para MP4',
    'converter.btn.cancel': 'Cancelar',
    'converter.btn.download': 'Baixar MP4',
    'converter.btn.again': 'Converter outro arquivo',
