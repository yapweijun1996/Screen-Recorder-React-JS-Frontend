                    ...
                    <div className="flex items-center justify-between gap-3">
                        <div className="min-w-0">
                            ...
                            <div className="text-xs text-slate-400">
                                {VIDEO_QUALITY_PRESETS[selectedQuality].label} • {selectedFormat.toUpperCase()}
                            </div>
                        </div>
                ...
                <div className="p-4 space-y-4 max-h-[60vh] overflow-y-auto">
                    ...
                    {showAdvanced && (
                        <div className="space-y-4 animate-fade-in">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-[11px] text-slate-500">{VIDEO_QUALITY_PRESETS[selectedQuality].description}</p>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-[11px] text-slate-500">帧率越高更流畅，但处理更慢。</p>
                            </div>
                    ...
                    {exportUrl && !isProcessing && (
                        <div className="bg-emerald-900/25 border border-emerald-500/30 p-4 rounded-xl text-center space-y-3 animate-fade-in">
                            <p className="text-emerald-300 text-sm font-medium">Export ready</p>
                            <a
                                href={exportUrl}
                ...
                <div className="p-4 border-t border-slate-800 bg-slate-900/70">
                    ...
                    {playbackError && (
                        <div className="mt-3 text-[11px] text-slate-500">
                            Fix playback issue by recording again.
                        </div>
                    )}
                </div>
            </div>
